package Keioshiri.Konstantin.FantasyCube.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    TITAN(FantasyCubeMod.MOD_ID + ":titan", 45, new int[] { 4, 7, 9, 4 }, 20,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2.0F, () -> { return Ingredient.fromItems(RegistryHandler.TITAN.get());  });
